...
import { mockprod as data } from "../data/mockData"
                    ...
                    <Tbody>
                        {data?.map((p) => {
                            return <Tr key={p?.id}>
                                ...
                                <Td>
                                    {/* <div>
                                        <ContentCopyIcon onClick={() => navigator.clipboard.writeText(p?.id)} />
                                        {p?.name}
                                    </div> */}
                                    {p?.id}
                                </Td>
                                ...
                                <Td>
                                    <div>
                                        <RemoveRedEyeOutlinedIcon onClick={() => window.open(`${process.env.REACT_APP_MAIN_SITE_URL}/product/${p?.id}`, "_blank")} />
                                        <EditIcon />
                                        <DeleteIcon />
                                    </div>
                                </Td>
